<?php
 ...
 if(isset($_SESSION['carrito'])){
   // Si Esta lo buscamos y ya esta agregado
   if(isset($_GET['id'])){
    ...
    if($encontro == true){
     ...
     $precioventa = "";
     $imagen="";
     $res=$conexion->query('select * from producto where id='.$_GET['id']) or die($conexion->error);
   ...
   //creamos una variable de seccion
   if(isset($_GET['id'])){
     $modelo = "";
     $precioventa = "";
     $imagen="";
                ...
                ?>
                  <tr>
                    <td class="product-thumbnail">
                      <img src="images/<?php echo $arregloCarrito[$i]['Imagen']?>" alt="Imagen" class="img-fluid">
                    </td>
          ...
          <div class="col-md-6">
            <div class="row mb-5">
              <div class="col-md-6 mb-3 mb-md-0">
                <button class="btn btn-dark btn-sm btn-block" onclick="window.location='cart.php'" >Actualizar Carrito</button>
              </div>
              <div class="col-md-6">
                <button class="btn btn-outline-dark btn-sm btn-block" onclick="window.location='checkout.php'">Continuar con la compra</button>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
              ...
              <div class="col-md-8 mb-3 mb-md-0">
                <input type="text" class="form-control py-3" id="coupon" placeholder="Código de descuento">
              </div>
              <div class="col-md-4">
                <button class="btn btn-dark btn-sm">Aplicar Cupón</button>
              </div>
            </div>
          </div>
          <div class="col-md-6 pl-5">
            <div class="row justify-content-end">
              <div class="col-md-7">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <button class="btn btn-dark btn-lg py-3 btn-block" onclick="window.location='checkout.php'">Confirmar Compra</button>
                  </div>
                </div>
              </div>
            </div>
